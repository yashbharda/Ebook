...
<!-- End Logout Modal-->
        ...
        <div class="col-md-6"> 
            <form action="search.jsp" class="form-inline my-2 my-lg-0" method="post">
               <input class="form-control mr-sm-2" type="search" required placeholder="Search" aria-label="Search" name="ch">
        ...
        <c:if test="${not empty userobj}">
            ...
            <a href="checkout.jsp" class="btn btn-primary"><i class="fas fa-cart-plus"></i> Cart</a>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="all_old_book.jsp"><i class="fas fa-book"> </i> Old Book</a>
      </li>
      
    </ul>
    <form class="form-inline my-2 my-lg-0">
      <a href="setting.jsp" class="btn btn-light my-2 my-sm-0"><i class="fas fa-cog"></i> Setting</a>
      <a href="helpline.jsp" class="btn btn-light my-2 my-sm-0 ml-1"><i class="fa-solid fa-phone"></i> Contact Us</a>
    </form>
  </div>
</nav>